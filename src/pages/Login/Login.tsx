...
const schema = yup.object({
  ...
  password: yup.string().min(8, 'Senha deve ter pelo menos 8 caracteres').required('O passoword é obrigatório'),
}).required();
            ...
            <div className="flex-shrink-0 w-full max-w-sm shadow-2xl card bg-base-100">
              <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                <div className="form-control">
                  ...
                  <input type="text" placeholder="Nome" className="input input-bordered"  {...register('email')} />
                </div> 
                <div className="form-control">
                  <label className="label">
                ...
                <div className="mt-6 form-control">
                  ...
                  <Link to={'/create-account'} className='pt-4 text-center'>
                    <span className="link link-accent">Ainda não tem conta? Criar Conta</span>
                  </Link>
                </div>
              </form>
            </div>
